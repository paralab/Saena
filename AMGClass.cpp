...
int AMGClass::findAggregation(COOMatrix* A, double* S){
...
//        }
    ...
    for(i=0; i<STi.size(); i++){
        // here STval should be Sval. It is written like this to be consistent with the julia code.
        if ( STval[i] <= connStrength) {
            continue;
        }
