...
// ===============================================
// functions removed from merge of master and lazy
// ===============================================
...
//            if(B1_nnz==6) {
//                std::cout << "\nCase3: before recursive2\nB1: nnz = " << B1_nnz << std::endl;
//                for (nnz_t i = 0; i < B1_col_size; i++) {
//                    for (nnz_t j = B1c_scan[i]; j < B1c_scan[i + 1]; j++) {
//                        std::cout << j << "\t" << B1r[j] << "\t" << i + B1_col_offset << "\t" << B1v[j] << std::endl;
//                    }
//                }
//                print_array(B1r, B1_nnz, 0, "B1r", comm);
//                print_array(B1v, B1_nnz, 0, "B1v", comm);
//                print_array(B1c_scan, B1_col_size + 1, 0, "B1c_scan", comm);
//            }
...
//            print_array(B2c_scan_temp, B2_col_size+1, 0, "B2c_scan_temp", comm);
//            print_array(B2r_temp, B2_nnz, 0, "B2r_temp", comm);
//            print_array(B2v_temp, B2_nnz, 0, "B2v_temp", comm);
