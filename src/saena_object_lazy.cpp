...
//            if(switch_to_dense && Ac->density > density_thre){
//                if(rank==0) printf("Switch to dense: density = %f, density_thre = %f \n", Ac->density, density_thre);
