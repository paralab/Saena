...
//    bool shrink_cpu          = true;
    ...
    const        index_t matmat_size_thre1 = 200000000; // if(row * col < matmat_size_thre1) decide to do case1 or not. default 20M, last 50M
    static const index_t matmat_size_thre2 = 200000000;  // if(nnz_row * nnz_col < matmat_size_thre2) do case1. default 1M
