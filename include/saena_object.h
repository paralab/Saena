...
//    bool shrink_cpu = true;
    ...
    const index_t matmat_size_thre1 = 100000000; // if(nnz_row * nnz_col < matmat_size_thre) do case1. default 10M
    const index_t matmat_size_thre2 = 10000000; // if(row * col < matmat_size_thre2) decide to do case1 or not. default 30M
