...
//    bool shrink_cpu = true;
    ...
    static const index_t matmat_size_thre2 = 5000000; // if(nnz_row * nnz_col < matmat_size_thre2) do case1. default 1M
    const index_t matmat_size_thre3        = 5000000;  // if(nnz_row * nnz_col < matmat_size_thre3) do dense, otherwise map. default 1M
