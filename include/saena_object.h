...
//    bool shrink_cpu = true;
    ...
    const index_t matmat_size_thre1        = 40000000; // if(row * col < matmat_size_thre1) decide to do case1 or not. default 20M
    static const index_t matmat_size_thre2 = 10000000; // if(nnz_row * nnz_col < matmat_size_thre2) do case1. default 1M
    const index_t matmat_size_thre3        = 10000000;  // if(nnz_row * nnz_col < matmat_size_thre3) do dense, otherwise map. default 1M
