...
//    double norm1, normInf, rhoDA;
    ...
    std::vector<value_d_t> vSend;
    std::vector<value_d_t> vecValues;
    std::vector<unsigned long> vSendULong;
    std::vector<unsigned long> vecValuesULong;

    std::vector<value_t> vSend_s;
    std::vector<value_t> vecValues_s;
    ...
    std::vector<value_d_t> w_buff; // for matvec3()
    std::vector<value_t> w_buff_s; // for matvec3()
...
//    int set3(unsigned int* row, unsigned int* col, double* val, unsigned int nnz_local);
    ...
    int matvec(std::vector<value_d_t>& v, std::vector<value_d_t>& w);
    int matvec_s(std::vector<value_t>& v, std::vector<value_t>& w);
...
//    int matvec_timing5_alltoall(std::vector<value_t>& v, std::vector<value_t>& w, std::vector<double>& time);
    ...
    int residual(std::vector<value_d_t>& u, std::vector<value_d_t>& rhs, std::vector<value_d_t>& res);
    int inverse_diag(std::vector<value_t>& x);
    int jacobi(int iter, std::vector<value_d_t>& u, std::vector<value_d_t>& rhs, std::vector<value_d_t>& temp);
    int chebyshev(int iter, std::vector<value_d_t>& u, std::vector<value_d_t>& rhs, std::vector<value_d_t>& temp, std::vector<value_d_t>& temp2);

    int residual_s(std::vector<value_t>& u, std::vector<value_t>& rhs, std::vector<value_t>& res);
//    int inverse_diag(std::vector<value_t>& x);
    int jacobi_s(int iter, std::vector<value_t>& u, std::vector<value_t>& rhs, std::vector<value_t>& temp);
    int chebyshev_s(int iter, std::vector<value_t>& u, std::vector<value_t>& rhs, std::vector<value_t>& temp, std::vector<value_t>& temp2);
