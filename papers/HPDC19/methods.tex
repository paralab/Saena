...
\begin{figure}[tbh]
 ...
 \caption{Case 1: comparison between dense structure method with hashmap for a 3D Poisson problem of size $216k$. The plot shows the number of times each method is better than the other one in intervals of $1M$ for $\nnzsz$.}
 \label{fig:lap60}
\end{figure}
...
\begin{figure}[tbh]
 ...
 \caption{Case 1: comparison between dense structure method with hashmap for matrix ID $1882$ from SuiteSparse (Florida) Matrix Collection. The plot shows the number of times each method is better than the other one in intervals of $1M$ for $\nnzsz$.}
 \label{fig:eco}
\end{figure}
