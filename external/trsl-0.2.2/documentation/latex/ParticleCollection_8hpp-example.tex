\hypertarget{ParticleCollection_8hpp-example}{
\subsection{ParticleCollection.hpp}
}
  ...
  namespace example {
    ...
    public:
      ...
      const_sample_iterator sample_begin(size_t sampleSize) const
        {
          is_picked predicate(sampleSize, totalWeight_, &Particle::getWeight);
          return const_sample_iterator(predicate, particles_.begin(), particles_.
      end());
        }
      ...
      const_sample_iterator sample_end() const
        {
          ...
          // avoid a useless call to random().
          is_picked predicate(1, 1, 0, &Particle::getWeight);
          return const_sample_iterator(predicate, particles_.end(), particles_.en
      d());
        }
    private:
