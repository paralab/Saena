\hypertarget{trsl__example1plus_8cpp-example}{
\subsection{trsl\_\-example1plus.cpp}
}
This example is an \char`\"{}advanced\char`\"{} version of \hyperlink{trsl__example1_8cpp-example}{trsl\_\-example1.cpp}. Instead of creating the sample iterators within the code body, we hide the creation detail within a population class.
