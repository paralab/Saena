// 1D array views; these classes are nested within send_zfp::array1
...
protected:
  ...
  void init()
  {
    // copy compressed send_stream
    zfp = zfp_stream_open(0);
    *zfp = *array->zfp;
    // copy bit send_stream
  ...
  zfp_stream* zfp;                // send_stream of compressed blocks
